...
- add i18n in your server_config.json file. (Dans cette Ordre)
- add dialogui in your server_config.json file. (Dans cette Ordre)
- add onsetrp in your server_config.json file. (Dans cette Ordre)
